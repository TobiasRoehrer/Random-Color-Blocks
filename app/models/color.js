app.factory("color", function () {
    function color(red,green,blue) {
        ...
        this.red = (red && red < 256 && red >= 0) ? red : (Math.floor(Math.random()*256));
        this.green = (green && green < 256 && green >= 0) ? green : (Math.floor(Math.random()*256));
        this.blue = (blue && blue < 256 && blue >= 0) ? blue : (Math.floor(Math.random()*256));
